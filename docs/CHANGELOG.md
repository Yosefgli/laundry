...
- 2026-05-17: fix: replace <symbol type="qrcode"> with <barcode type="code128"> (no {B} prefix) in ePOS receipt+label; scan API now strips Code 128 mode-switch prefix and accepts both UUID and L-NNNNNN order_number formats.